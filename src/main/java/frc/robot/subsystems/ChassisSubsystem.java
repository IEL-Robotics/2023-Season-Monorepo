...
public class ChassisSubsystem extends SubsystemBase {
  ...
  private CANSparkMax m_leftMaster, m_rightMaster, m_leftSlave, m_rightSlave, m_midMaster, m_midSlave;
  public RelativeEncoder leftEncoder, rightEncoder, midEncoder;
  ...
  public ChassisSubsystem() {
    ...
    this.m_rightMaster = new CANSparkMax(ChassisConstants.idRigthMaster, MotorType.kBrushless);
    ...
    this.m_midMaster = new CANSparkMax(ChassisConstants.idMidMaster, MotorType.kBrushless);
    this.m_midSlave = new CANSparkMax(ChassisConstants.idMidSlave, MotorType.kBrushless);
    ...
    this.m_midMaster.setIdleMode(IdleMode.kBrake);
    this.m_midSlave.setIdleMode(IdleMode.kCoast);

    this.m_leftMaster.setInverted(false);
    this.m_rightMaster.setInverted(true); // dunno why, be careful tho
    this.m_midMaster.setInverted(false);
    ...
    this.midEncoder = this.m_midMaster.getEncoder(SparkMaxRelativeEncoder.Type.kHallSensor, 42);
    ...
    this.midEncoder.setPositionConversionFactor(Math.PI * 6 / 8.46 / 39.37);
